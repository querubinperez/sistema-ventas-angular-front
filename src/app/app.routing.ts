...
import { SedeIndexComponent } from './components/sedes/sede_index/sede-index.component';
import {SedeCreateComponent} from "./components/sedes/sede_create/sede-create.component";
import {SedeEditComponent} from "./components/sedes/sede_edit/sede-edit.component";
...
const appRoute : Routes = [
    ...
    {path: 'sedes',component: SedeIndexComponent},
    {path: 'sede/registrar',component: SedeCreateComponent},
    {path: 'sede/editar/:id', component: SedeEditComponent},
